...
extension HMainController3 {
    ...
    @objc func tupleExa1_numberOfItemsInSection(_ section: NSInt) -> NSInt {
    ...
    @objc func tupleExa1_tupleItem(_ itemObject: NSTupleItem, atIndexPath indexPath: IndexPath) {

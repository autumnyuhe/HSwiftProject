...
class HMainViewController: HTupleController {
    ...
    func numberOfSectionsInTupleView() -> HObject {
        return HObject(value: 1)
    }
    func numberOfItemsInSection(_ section: Int) -> HObject {
        return HObject(value: 8)
    }
    func insetForSection(_ section: Int) -> HObject {
        return UIEdgeInsetsMake(0, 10, 0, 10).hObject
    }
    func colorForSectionAt(_ section: Int) -> UIColor {
        return UIColor.red
    }
    func sizeForItemAtIndexPath(_ indexPath: NSIndexPath) -> HObject {
        switch indexPath.row {
        case 0:
            return CGSizeMake(self.tupleView.widthWithSection(indexPath.section), 65).hObject
        case 1:
            return CGSizeMake(self.tupleView.widthWithSection(indexPath.section), 65).hObject
        case 2:
            return CGSizeMake(self.tupleView.widthWithSection(indexPath.section), 65).hObject
        case 3:
            ...
            return CGSizeMake(width, 120).hObject
        case 4:
            var width: CGFloat = self.tupleView.widthWithSection(indexPath.section)
            width = self.tupleView.fixSlitWith(width, colCount: 3, index: indexPath.row-3)
            return CGSizeMake(width, 120).hObject
    ...
    func edgeInsetsForItemAtIndexPath(_ indexPath: NSIndexPath) -> HObject {
        switch (indexPath.row) {
            case 3:
                return UIEdgeInsetsMake(10, 10, 10, 5).hObject
            case 4:
                return UIEdgeInsetsMake(10, 5, 10, 5).hObject
            case 5:
                return UIEdgeInsetsMake(10, 5, 10, 10).hObject
            default:
                return UIEdgeInsetsMake(10, 10, 10, 10).hObject
        }
    }

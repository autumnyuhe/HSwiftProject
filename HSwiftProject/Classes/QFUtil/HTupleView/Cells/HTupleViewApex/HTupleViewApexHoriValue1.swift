...
class HTupleViewApexHoriBase1 : HTupleBaseApex {
    ///imageView的上下左右边距
...
class HTupleViewApexHoriBase2 : HTupleBaseApex {
    ///imageView的上下左右边距
    var imageViewInsets: UIEdgeInsets = UIEdgeInsetsZero
    ///label的左右边距
...
class HTupleViewApexHoriBase3 : HTupleBaseApex {
    ///imageView的上下左右边距
    var imageViewInsets: UIEdgeInsets = UIEdgeInsetsZero
    ///label的上下边距
...
///三个label纵向显示
class HTupleViewApexHoriValue4 : HTupleViewApexHoriBase3 {

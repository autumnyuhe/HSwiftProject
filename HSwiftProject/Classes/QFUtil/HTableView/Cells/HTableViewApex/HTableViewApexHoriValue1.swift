...
///两个label左右相距排列
class HTableViewApexHoriValue1 : HTableViewApexHoriBase1 {
...
///两个label左右对立排列
class HTableViewApexHoriValue2 : HTableViewApexHoriBase1 {
...
///三个label横向显示
class HTableViewApexHoriValue3 : HTableViewApexHoriBase2 {
...
///三个label纵向显示
class HTableViewApexHoriValue4 : HTableViewApexHoriBase3 {

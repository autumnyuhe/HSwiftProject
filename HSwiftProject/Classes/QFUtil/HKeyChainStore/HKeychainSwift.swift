...
open class HKeychainSwift {
  ...
  */
  ...
  open func set(_ value: Data, forKey key: String,
    ...
    let accessible = access?.value ?? HKeychainSwiftAccessOptions.defaultOption.value
    ...
    var query: [String : Any] = [
      ...
      HKeychainSwiftConstants.valueData   : value,
      HKeychainSwiftConstants.accessible  : accessible
    ]
  ...
  */
  ...
  func addAccessGroupWhenPresent(_ items: [String: Any]) -> [String: Any] {
    ...
    result[HKeychainSwiftConstants.accessGroup] = accessGroup
    return result
  }
  ...
  */
  func addSynchronizableIfRequired(_ items: [String: Any], addingItems: Bool) -> [String: Any] {
    ...
    var result: [String: Any] = items
    result[HKeychainSwiftConstants.attrSynchronizable] = addingItems == true ? true : kSecAttrSynchronizableAny
    return result
  }
}
